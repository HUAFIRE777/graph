# Graph Paper 数学坐标方格纸与 3D 等轴测几何画板

- **生产域名**: `https://graph.eazyopc.com`
- **功能定位**: 面向数学师生与科研人员的高精度 5mm 数学方格纸、极坐标同心网格，支持一键绘制 3D 等轴测立方体、圆柱、棱锥与空间直角坐标系。
...
1. 在 GitHub 建立公开仓库并推送：
   ```bash
   cd /Users/huafire777/Desktop/program/graph
   git init
   git add .
   git commit -m "feat: initial commit for graph"
   gh repo create graph --public --source=. --remote=origin --push
   ```
2. 登录 [Cloudflare Dashboard](https://dash.cloudflare.com/)：
   ...
   - **构建预设**: `None`（纯静态项目）；
   - 点击 **保存并部署**。
3. 在自定义域绑定 `graph.eazyopc.com`，并在 Namecheap 加一条 CNAME 记录即可！
